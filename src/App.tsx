...
레거시 그누보드 환경의 스크립트를 표준 코드로 개선하며 단기적인 구현에 그치지 않고, 유지보수와 개선까지 책임지는 관점으로 프로젝트에 임해왔습니다. 반응형 웹 구현과 정교한 마크업을 기반으로 사용자 경험을 개선하고, JavaScript를 활용한 인터랙션을 구현하며 완성도를 높였습니다. 
디자인 시안을 높은 완성도로 구현하는 데 강점이 있으며, 간단한 UI 및 정적 랜딩페이지 디자인에 참여한 경험을 통해 기획과 디자인 의도를 정확히 이해하고 이를 충실히 반영할 수 있습니다. 
디자이너를 협업 파트너이자 또 하나의 클라이언트로 생각하며, 적극적인 소통을 통해 결과물의 완성도를 높이는 과정에서 큰 즐거움을 느낍니다.
`}
                  </p>
                  ...
                  <div className={cx(s.history, stack())}>
                    <div>
                      ...
                      <div className={s.historyContainer}>
                        ...
                        <div className={s.eachHistory}>
                          <p className="group">
                            해커스홀딩스 <span className="job">(인턴)</span>
                          </p>
